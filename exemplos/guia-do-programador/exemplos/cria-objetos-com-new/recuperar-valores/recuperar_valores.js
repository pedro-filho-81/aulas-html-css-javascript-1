 ...
 /* OUTRA mANEIRA PARA RECUPERAR VALORES DE PROPRIEDADES, mÉTODOS E VARIÁVEIS DE Um OBJETO. */

// variável recebe a string do objeto livro que está na propriedade autor
let nomeDoAutor = livro.autor;

// variável recebe a string do objeto livro que está na propriedade capitulo5
let capituloCinco = livro.capitulo5;

// variável recebe o valor que está no método function do objeto livro
let valorDoFrete = livro.freteSedex(22050047, 69190120, 1060);

// exibe os valores
alert(`Nova maneira de exibir\n Autor: ${nomeDoAutor}\n CapítuloCinco: ${capituloCinco}\n valorDoFrete R$: ${valorDoFrete}`);